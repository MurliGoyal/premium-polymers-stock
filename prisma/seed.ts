...
async function main() {
  ...
  // ─── Raw Materials ──────────────────────────────────────────
  const materialsData = [
    { name: "HDPE Resin HM9450F", cat: "polymer-resin", unit: "kg", stock: 2500, min: 500, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "LDPE Film Grade FE8000", cat: "polymer-resin", unit: "kg", stock: 1800, min: 400, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "PP Copolymer RC5032", cat: "polymer-resin", unit: "kg", stock: 120, min: 300, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "EVA Hot Melt Adhesive 7420", cat: "adhesive", unit: "kg", stock: 350, min: 100, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "PET Shrink Film 25μ", cat: "film-sheet", unit: "roll", stock: 45, min: 20, wh: warehouseE219.id, thickness: 0.025, size: "1000x5000", gsm: 25 },
    { name: "BOPP Metallised Film", cat: "film-sheet", unit: "roll", stock: 12, min: 15, wh: warehouseE219.id, thickness: 0.012, size: "800x3000", gsm: 20 },
    { name: "Titanium Dioxide (TiO2)", cat: "colorant-masterbatch", unit: "kg", stock: 800, min: 200, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "Carbon Black Masterbatch", cat: "colorant-masterbatch", unit: "kg", stock: 0, min: 150, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
    { name: "UV Stabilizer Tinuvin 770", cat: "chemical-additive", unit: "kg", stock: 180, min: 50, wh: warehouseE219.id, thickness: null, size: null, gsm: null },
